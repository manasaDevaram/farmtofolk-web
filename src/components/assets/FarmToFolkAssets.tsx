...
export function LeafMark({ className = "" }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} fill="none" viewBox="0 0 44 44">
      ...
      <path
        d="m22 20-8-8m9 14 9-9"
        stroke="var(--ftf-paper-light)"
        strokeLinecap="round"
        strokeWidth="1.3"
      />
    </svg>
...
export function LeafDivider() {
  return (
    <div aria-hidden="true" className="ftf-leaf-divider">
      <span />
    </div>
  );
}
...
export function Seedling({ className = "" }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} fill="none" viewBox="0 0 64 64">
      ...
      <path
        d="M31 32C18 32 12 25 12 13c12 0 20 7 19 19Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="2.5"
      />
      <path
        d="M33 38c13 0 20-7 20-20-13 0-21 8-20 20Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="2.5"
      />
...
export function EmptyBasket({ className = "" }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} fill="none" viewBox="0 0 80 80">
      <path
        d="m18 32 6 30h32l6-30H18Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="2.5"
      />
      <path
        d="M29 36c0-14 22-14 22 0"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="2.5"
      />
      <path
        d="M32 22c-7-1-11-5-12-11 7 0 11 4 12 11Zm3 2c8-1 13-6 14-14-8 1-13 6-14 14Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="2"
      />
      <path
        d="M28 43v12m12-12v12m12-12v12"
        stroke="currentColor"
        strokeLinecap="round"
        opacity=".5"
        strokeWidth="2"
...
export function FtfIconCircle({
  children,
  tone = "green",
}: {
  children: ReactNode;
  tone?: "green" | "clay" | "kraft";
}) {
